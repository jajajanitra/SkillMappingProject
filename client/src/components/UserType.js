...
function UserType() {
    ...
    return (
        <div className="card p-4 m-4">
            ...
            <div>
                <h3 className="text-xl md:text-3xl text-center text-dark-purple-font">เลือกเลยว่าคุณเป็นคนแบบไหน?</h3>
            </div>
            ...
            <div className="grid justify-items-center md:flex md:justify-evenly">
                <div class="user-card">
                    <a href="/student_careers" className="card-link">
                        ...
                        <div class="p-4">
                            <h5 class="card-subheader md:text-xl">มีอาชีพที่สนใจ</h5>
                        </div>    
                    </a>
                </div>
                ...
                <div class="user-card">
                    <a href="/student_suggestion" className="card-link">
                        ...
                        <div class="p-4">
                            <h5 class="card-subheader md:text-xl">ยังไม่รู้ว่าอยากทำอาชีพอะไร</h5>
                        </div>    
                    </a>
                </div>
            </div>  
